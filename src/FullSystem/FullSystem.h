...
#include "LoopClosing/Optimizer.h"
#include <math.h>
#include <memory>
...
public:
    ...
    std::shared_ptr<ORBextractor> orb;
...
private:
	...
	void traceNewCoarse(FrameHessian* fh, bool isKeyframe);
	void activatePoints();
	...
	std::vector<FrameHessian*> frameHessians;	// ONLY changed in marginalizeFrame and addFrame.当前维护的几个关键帧
