...
int main( int argc, char** argv )
{
    ...
    std::thread runthread([&]() {
        ...
        for(int ii=0;ii<(int)idsToPlay.size(); ii++)
        {
            ...
            //save images
//            std::vector<std::string> Index{"","0","00","000","0000"};
//            std::string name = std::to_string(ii);
//            name = "images_out/" + Index[5 - name.size()] + name + ".jpg";
//            cv::imwrite(name, img->image_mat);
